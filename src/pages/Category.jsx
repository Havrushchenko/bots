            ...
            <motion.div variants={wrapper} initial="hidden" animate="show" className="flex justify-center mt-64">
                <div className="">
                    <div className="flex flex-col items-center p-6 bg-white rounded-lg shadow-lg">
                        ...
                        <button className="flex items-center gap-2 mb-6 mr-[430px] hover:bg-gray-100 focus:ring-4 focus:ring-gray-300 font-medium rounded-lg text-sm px-4 lg:px-5 py-2 lg:py-2.5 dark:hover:bg-gray-700 focus:outline-none dark:focus:ring-gray-800"><AiOutlinePlus></AiOutlinePlus>Add new category</button>
                        <div className="flex w-max gap-96">
